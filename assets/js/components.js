/* ============================================
   FIRST FlYDigital Solution — Shared Components
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-brand">
                    ...
                    <p>FIRST FlYDigital Solution is a premium digital engineering studio building fast, futuristic, and
                        SEO-optimized static websites.</p>
                    <div class="footer-social">
                        <a href="https://facebook.com/firstflydigital" target="_blank" aria-label="Facebook"><svg
                                viewBox="0 0 24 24">
                                <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                            </svg></a>
                        <a href="https://twitter.com/firstflydigital" target="_blank" aria-label="Twitter"><svg
                                viewBox="0 0 24 24">
                                <path
                                    d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                            </svg></a>
                        <a href="https://youtube.com/@firstflydigital" target="_blank" aria-label="YouTube"><svg
                                viewBox="0 0 24 24">
                                <path
                                    d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                            </svg></a>
                        <a href="https://instagram.com/firstflydigital" target="_blank" aria-label="Instagram"><svg
                                viewBox="0 0 24 24">
                                <path
                ...
                <div class="footer-col">
                    ...
                    <a href="https://wa.me/919025676853" target="_blank">WhatsApp</a>
                </div>
            </div>
            <div class="footer-bottom">
                &copy; 2026 FIRST FlYDigital Solution. All Rights Reserved.
            </div>
        </div>
    </footer>
  `;
